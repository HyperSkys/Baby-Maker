    ...
    public void shoot() {
        switch (color) {
            case WHITE:
                if(location.equals(Location.VAGINA) && target != Target.BOY) {
                    for(int i = 0; i <= spermCount; i++) {
                        Sperm sperm = new Sperm(owner + " Sperm ["+i+"]");
                ...
                if(location.equals(Location.MOUTH) && target != Target.BOY) {
                    for(int i = 0; i <= spermCount; i++) {
                        Sperm sperm = new Sperm(owner + " Stomach Sperm ["+i+"]");
                ...
                if(location.equals(Location.ASS) && target != Target.BOY) {
                    for(int i = 0; i <= spermCount; i++) {
                        Sperm sperm = new Sperm(owner + " Shit Sperm ["+i+"]");
            ...
            case GREEN:
                if(location.equals(Location.VAGINA) && target != Target.BOY) {
                    for(int i = 0; i <= spermCount; i++) {
                        Sperm sperm = new Sperm(owner + " Alien Sperm ["+i+"]");
                ...
                if(location.equals(Location.MOUTH) && target != Target.BOY) {
                    for(int i = 0; i <= spermCount; i++) {
                        Sperm sperm = new Sperm(owner + " Alien Stomach Sperm ["+i+"]");
                ...
                if(location.equals(Location.ASS) && target != Target.BOY) {
                    for(int i = 0; i <= spermCount; i++) {
                        Sperm sperm = new Sperm(owner + " Alien Shit Sperm ["+i+"]");
            ...
            default:
                System.out.println("What kind of fucking alien baby is this?");
                System.exit(0);
        }
    }
}
